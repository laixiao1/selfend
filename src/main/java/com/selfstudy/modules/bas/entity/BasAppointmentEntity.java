...
public class BasAppointmentEntity implements Serializable {
    ...
    // 新增：关联查询字段
    @TableField(exist = false)
    private String floor;      // 对应SQL中的bas_floor.floor
    @TableField(exist = false)
    private String roomName;   // 对应SQL中的bas_study_room.room_name
    @TableField(exist = false)
    private String seatNumber;   // 对应SQL中的bas_seat.seat_name
}